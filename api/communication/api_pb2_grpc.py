...
class CloudService(object):
    ...
    def GetUpdatedModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.communication.CloudService/GetUpdatedModel',
    ...
    def GetModelInference(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.communication.CloudService/GetModelInference',
    ...
    def GetInitialModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.communication.CloudService/GetInitialModel',
            api_dot_communication_dot_api__pb2.ModelUpdateRequest.SerializeToString,
            api_dot_communication_dot_api__pb2.ModelUpdateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
